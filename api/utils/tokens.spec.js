...
describe('getModelMaxTokens', () => {
  ...
  test('should return correct tokens for partial match - Google models', () => {
    ...
    expect(getModelMaxTokens('gemini-3-pro-preview', EModelEndpoint.google)).toBe(
      maxTokensMap[EModelEndpoint.google]['gemini-3-pro-preview'],
    );
    expect(getModelMaxTokens('gemini-3-flash-preview', EModelEndpoint.google)).toBe(
      maxTokensMap[EModelEndpoint.google]['gemini-3-flash-preview'],
    );
