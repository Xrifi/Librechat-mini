...
/* Admin */
export function getAdminOverview(): Promise<any> {
  return request.get('/api/admin/status/overview');
}

export function getAdminUsage(): Promise<any> {
  return request.get('/api/admin/status/usage');
}

export function getQuotaProfiles(): Promise<any[]> {
  return request.get('/api/admin/quotas/profiles');
}

export function createQuotaProfile(payload: any): Promise<any> {
  return request.post('/api/admin/quotas/profiles', payload);
}

export function updateQuotaProfile({ id, payload }: { id: string; payload: any }): Promise<any> {
  return request.put(`/api/admin/quotas/profiles/${id}`, payload);
}

export function deleteQuotaProfile(id: string): Promise<any> {
  return request.delete(`/api/admin/quotas/profiles/${id}`);
}

export function getQuotaAssignments(): Promise<any[]> {
  return request.get('/api/admin/quotas/assignments');
}

export function createQuotaAssignment(payload: any): Promise<any> {
  return request.post('/api/admin/quotas/assignments', payload);
}

export function deleteQuotaAssignment(id: string): Promise<any> {
  return request.delete(`/api/admin/quotas/assignments/${id}`);
}

export function getAdminUsers(params: { page: number; search?: string }): Promise<any> {
  return request.get('/api/admin/users', { params });
}

export function adjustUserCredits(payload: { userId: string; amount: number; reason?: string }): Promise<any> {
  return request.post('/api/admin/users/credits', payload);
}

export function getAdminAuditLogs(params: { page: number }): Promise<any> {
  return request.get('/api/admin/audit', { params });
}

export function updateUserRole(payload: { userId: string; role: string }): Promise<any> {
  return request.put(`/api/admin/users/${payload.userId}`, { role: payload.role });
}
