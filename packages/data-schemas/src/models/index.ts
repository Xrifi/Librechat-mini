...
import { createQuotaProfileModel } from './quotaProfile';
import { createQuotaAssignmentModel } from './quotaAssignment';
import { createUsageRollupModel } from './usageRollup';
import { createAdminAuditModel } from './adminAudit';
...
export function createModels(mongoose: typeof import('mongoose')) {
  return {
    ...
    QuotaProfile: createQuotaProfileModel(mongoose),
    QuotaAssignment: createQuotaAssignmentModel(mongoose),
    UsageRollup: createUsageRollupModel(mongoose),
    AdminAudit: createAdminAuditModel(mongoose),
  };
}
